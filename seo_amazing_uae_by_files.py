...
# -*- coding: utf-8 -*-
"""
تهيئة السيو وسكيما لجميع ملفات المنتجات في products ريبو amazing-uae
"""
...
def extract_image(html):
    ...
    if m:
        ...
        if src.startswith('http'):
            return src
        return f"https://sherow1982.github.io/amazing-uae/{src.lstrip('/')}"
    return "https://sherow1982.github.io/amazing-uae/logo.png"
...
def build_product_url(file_path: Path):
    name = file_path.name
    return f"https://sherow1982.github.io/amazing-uae/products/{name}"
...
{{
  ...
  "name": "{title}",
  "image": ["{image}"],
  "description": "{title} - تسوق الآن من Amazing UAE مع توصيل سريع لجميع الإمارات.",
  "sku": "",
  "mpn": "",
  "brand": {{
    "@type": "Brand",
    ...
    return """
{
  ...
  "@type": "LocalBusiness",
  "name": "Amazing UAE",
  "image": "https://sherow1982.github.io/amazing-uae/logo.png",
  "url": "https://sherow1982.github.io/amazing-uae/",
...
def create_meta_tags(title, desc, image, url, price):
    ...
    meta = f"""
    <!-- SEO Meta Tags -->
    <title>{title} - Amazing UAE | أفضل العروض والأسعار</title>
    <meta name="description" content="{desc} اشتري الآن من Amazing UAE - توصيل سريع لكل الإمارات.">
    <meta name="keywords" content="{title}, Amazing UAE, تسوق اونلاين, منتجات الإمارات, عروض, {emirates_cities}">
    ...
    <meta property="og:title" content="{title} - Amazing UAE">
    <meta property="og:description" content="{desc}">
    <meta property="og:image" content="{image}">
    <meta property="og:url" content="{url}">
    <meta property="og:type" content="product">
    <meta property="og:site_name" content="Amazing UAE">
    <meta property="og:locale" content="ar_AE">
    <meta property="product:price:amount" content="{price}">
    <meta property="product:price:currency" content="AED">
    <!-- Twitter Card Meta Tags -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="{title} - Amazing UAE">
...
def main():
    print("\n" + "="*60)
    print("🇦🇪 سكربت سيو/سكيما لكل ملفات المنتجات في products - Amazing UAE 🇦🇪")
    print("="*60 + "\n")
